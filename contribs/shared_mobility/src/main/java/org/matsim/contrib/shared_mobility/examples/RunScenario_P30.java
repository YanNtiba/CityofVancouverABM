 ...
 */
public final class RunScenario_P30 {

	private static final String CONFIG_PATH = "C:/Users/yanni/MatsimProjects/exampleproject/scenarios/equil/25config_bikeshare_30min.xml";
	...
	public static void main(String[] args) {
		...
		controller.addOverridingModule(new AbstractModule() {
			@Override
			public void install() {
				// This is the "knob" for this specific scenario file: 0 free minutes.
				double promoFreeMinutes = 30.0;
