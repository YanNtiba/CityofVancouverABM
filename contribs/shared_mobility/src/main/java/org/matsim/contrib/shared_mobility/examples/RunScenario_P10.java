 ...
 */
public final class RunScenario_P10 {

	private static final String CONFIG_PATH = "C:/Users/yanni/MatsimProjects/exampleproject/scenarios/equil/25config_bikeshare_10min.xml";
	...
	private static final double WALK_RADIUS = 600.0;
	...
	public static void main(String[] args) {
		...
		controller.addOverridingModule(new AbstractModule() {
			@Override
			public void install() {
				// This is the "knob" for this specific scenario file: 10 free minutes.
				double promoFreeMinutes = 10.0;
